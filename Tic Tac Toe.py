...
reset_button = Button(text='Reset', font=('consolas', 25), command=new_game)
...
for row in range(3):
    for column in range (3):
        buttons[row][column] = Button(frame, text="", font=('consolas',25), width=5, height=2, command= lambda row=row, column=column: next_turn(row,column))
